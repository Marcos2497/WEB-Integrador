        ...
        <div class="bg-gray-100 p-10 rounded-2xl shadow-lg hover:shadow-2xl transition-all">
            <div class="bg-indigo-50 p-10 rounded-2xl shadow-lg hover:shadow-2xl transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8">
                    ...
                    <!-- Tipo -->
                    <div class="space-y-3">
                        <label for="tipo" class="font-semibold text-gray-700">Tipo:</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                                <i class="bi bi-list text-green-500 text-xl"></i>
                            </span>
                            <select wire:model="tipo" id="tipo" name="tipo"
                                class="pl-10 w-full border border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-lg shadow-sm transition-all @error('tipo') border-red-500 @enderror">
